<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'address',array('class'=>'span5','maxlength'=>100,'onChange'=>'js:showObject(this.value)')); ?>
	...
	<script type="text/javascript">
		...
		YMaps.jQuery(function() {
			...
			// когда страница загрузится, отобразить сауну на карте
			var address = YMaps.jQuery('#Sauna_address').val();
			showObject(address);
		});
	</script>	
	...
	<?php echo $form->textAreaRow($model,'description',array('rows'=>12, 'cols'=>50, 'class'=>'span8')); ?>
