...
class ProfileField extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => UserModule::t('ID'),
			'varname' => UserModule::t('Имя переменной'),
			'title' => UserModule::t('Название'),
			'field_type' => UserModule::t('Тип поля'),
			'field_size' => UserModule::t('Размер поля'),
			'field_size_min' => UserModule::t('Минимальный размер поля'),
